...
### 壱岐島の状況を確認するためのコード(長崎県壱岐市用コード42210)
...
# 壱岐市の筆ポリゴン
fude <- read_sf("data/raw/vector_data/42210_Iki_2021/42210壱岐市（2021公開）_5.shp",
